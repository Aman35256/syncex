...
function App() {
  ...
  const submitSignup = (event) => {
    ...
    run(
      ...
      () => {
        ...
        setNotice({
          type: "success",
          text: `We sent a 6-digit code via ${signup.otpMethod}.`,
        });
      },
    );
  };
  ...
  const submitProfile = (event) => {
    event.preventDefault();
    run(
      () => authService.createProfile(profile),
      () => {
        setMode("signin");
        setStep(1);
        setNotice({
          type: "success",
          text: "Your space is ready. Sign in to continue.",
        });
      },
    );
  };
  ...
  return (
    <main className="page-shell">
      <section className="story-panel">
        ...
        <footer>
          Made with <Heart size={13} fill="currentColor" /> for your peace of
          mind
        </footer>
      </section>
        ...
        <div className="auth-card">
          ...
          {mode === "signup" && step === 1 && (
            <form onSubmit={submitSignup}>
              <Heading
                ...
                text="A few details and your space will be ready."
              />
          ...
          {mode === "signup" && step === 2 && (
            <form onSubmit={submitOtp}>
              ...
              <Heading
                ...
                text={`Enter the code we sent to ${signup.otpMethod === "Email" ? maskEmail(signup.email) : `••••••${signup.phonenumber.slice(-4)}`}.`}
              />
              <div
                className="otp-row"
                onPaste={(event) => {
          ...
          {mode === "signup" && step === 3 && (
            <form onSubmit={submitProfile}>
              <Heading
                ...
                text="Add the finishing touches to your profile."
              />
          ...
          {mode === "signin" && (
            <form onSubmit={submitSignin}>
              ...
              <Heading
                title="Welcome back"
                text="Your calm corner has been waiting for you."
              />
              <Field label="Email address" icon={<Mail />} required>
                <input
                  type="email"
          ...
          <div className="privacy-note">
            <ShieldCheck size={15} /> Your details are encrypted and always
            yours.
          </div>
        </div>
      </section>
